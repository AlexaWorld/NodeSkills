...
const intentHandler = function (alexaRequest) {
	...
	var text = this.skill.GetRandomText(alexaRequest.Translate(requestName));
...
function getHandler(skill,repromt) {
	var context = {
		skill: skill,
		repromt : repromt
	};
...
module.exports.AddToSkill = function (skill) {
	...
	skill.AddIntentHandler('AMAZON.YesIntent', getHandler(skill, "War's das?"));
}
/*
